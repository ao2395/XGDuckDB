...
set_target_properties(duckdb PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libduckdb.so"
  IMPORTED_SONAME_RELEASE "libduckdb.so"
  )

list(APPEND _cmake_import_check_targets duckdb )
list(APPEND _cmake_import_check_files_for_duckdb "${_IMPORT_PREFIX}/lib64/libduckdb.so" )
...
set_target_properties(duckdb_static PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libduckdb_static.a"
  )

list(APPEND _cmake_import_check_targets duckdb_static )
list(APPEND _cmake_import_check_files_for_duckdb_static "${_IMPORT_PREFIX}/lib64/libduckdb_static.a" )

# Import target "tpch_extension" for configuration "Release"
set_property(TARGET tpch_extension APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(tpch_extension PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libtpch_extension.a"
  )

list(APPEND _cmake_import_check_targets tpch_extension )
list(APPEND _cmake_import_check_files_for_tpch_extension "${_IMPORT_PREFIX}/lib64/libtpch_extension.a" )

# Import target "tpcds_extension" for configuration "Release"
set_property(TARGET tpcds_extension APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(tpcds_extension PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libtpcds_extension.a"
  )

list(APPEND _cmake_import_check_targets tpcds_extension )
list(APPEND _cmake_import_check_files_for_tpcds_extension "${_IMPORT_PREFIX}/lib64/libtpcds_extension.a" )
...
set_target_properties(core_functions_extension PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libcore_functions_extension.a"
  )

list(APPEND _cmake_import_check_targets core_functions_extension )
list(APPEND _cmake_import_check_files_for_core_functions_extension "${_IMPORT_PREFIX}/lib64/libcore_functions_extension.a" )
...
set_target_properties(parquet_extension PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libparquet_extension.a"
  )

list(APPEND _cmake_import_check_targets parquet_extension )
list(APPEND _cmake_import_check_files_for_parquet_extension "${_IMPORT_PREFIX}/lib64/libparquet_extension.a" )
...
set_target_properties(jemalloc_extension PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libjemalloc_extension.a"
  )

list(APPEND _cmake_import_check_targets jemalloc_extension )
list(APPEND _cmake_import_check_files_for_jemalloc_extension "${_IMPORT_PREFIX}/lib64/libjemalloc_extension.a" )
...
set_target_properties(duckdb_fmt PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libduckdb_fmt.a"
  )

list(APPEND _cmake_import_check_targets duckdb_fmt )
list(APPEND _cmake_import_check_files_for_duckdb_fmt "${_IMPORT_PREFIX}/lib64/libduckdb_fmt.a" )
...
set_target_properties(duckdb_duckdb_pg_query PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libduckdb_pg_query.a"
  )

list(APPEND _cmake_import_check_targets duckdb_duckdb_pg_query )
list(APPEND _cmake_import_check_files_for_duckdb_duckdb_pg_query "${_IMPORT_PREFIX}/lib64/libduckdb_pg_query.a" )
...
set_target_properties(duckdb_re2 PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libduckdb_re2.a"
  )

list(APPEND _cmake_import_check_targets duckdb_re2 )
list(APPEND _cmake_import_check_files_for_duckdb_re2 "${_IMPORT_PREFIX}/lib64/libduckdb_re2.a" )
...
set_target_properties(duckdb_duckdb_miniz PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libduckdb_miniz.a"
  )

list(APPEND _cmake_import_check_targets duckdb_duckdb_miniz )
list(APPEND _cmake_import_check_files_for_duckdb_duckdb_miniz "${_IMPORT_PREFIX}/lib64/libduckdb_miniz.a" )
...
set_target_properties(duckdb_utf8proc PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libduckdb_utf8proc.a"
  )

list(APPEND _cmake_import_check_targets duckdb_utf8proc )
list(APPEND _cmake_import_check_files_for_duckdb_utf8proc "${_IMPORT_PREFIX}/lib64/libduckdb_utf8proc.a" )
...
set_target_properties(duckdb_hyperloglog PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libduckdb_hyperloglog.a"
  )

list(APPEND _cmake_import_check_targets duckdb_hyperloglog )
list(APPEND _cmake_import_check_files_for_duckdb_hyperloglog "${_IMPORT_PREFIX}/lib64/libduckdb_hyperloglog.a" )
...
set_target_properties(duckdb_skiplistlib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libduckdb_skiplistlib.a"
  )

list(APPEND _cmake_import_check_targets duckdb_skiplistlib )
list(APPEND _cmake_import_check_files_for_duckdb_skiplistlib "${_IMPORT_PREFIX}/lib64/libduckdb_skiplistlib.a" )
...
set_target_properties(duckdb_fastpforlib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libduckdb_fastpforlib.a"
  )

list(APPEND _cmake_import_check_targets duckdb_fastpforlib )
list(APPEND _cmake_import_check_files_for_duckdb_fastpforlib "${_IMPORT_PREFIX}/lib64/libduckdb_fastpforlib.a" )
...
set_target_properties(duckdb_mbedtls PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libduckdb_mbedtls.a"
  )

list(APPEND _cmake_import_check_targets duckdb_mbedtls )
list(APPEND _cmake_import_check_files_for_duckdb_mbedtls "${_IMPORT_PREFIX}/lib64/libduckdb_mbedtls.a" )
...
set_target_properties(duckdb_fsst PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libduckdb_fsst.a"
  )

list(APPEND _cmake_import_check_targets duckdb_fsst )
list(APPEND _cmake_import_check_files_for_duckdb_fsst "${_IMPORT_PREFIX}/lib64/libduckdb_fsst.a" )
...
set_target_properties(duckdb_duckdb_yyjson PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libduckdb_yyjson.a"
  )

list(APPEND _cmake_import_check_targets duckdb_duckdb_yyjson )
list(APPEND _cmake_import_check_files_for_duckdb_duckdb_yyjson "${_IMPORT_PREFIX}/lib64/libduckdb_yyjson.a" )
...
set_target_properties(duckdb_duckdb_zstd PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libduckdb_zstd.a"
  )

list(APPEND _cmake_import_check_targets duckdb_duckdb_zstd )
list(APPEND _cmake_import_check_files_for_duckdb_duckdb_zstd "${_IMPORT_PREFIX}/lib64/libduckdb_zstd.a" )
